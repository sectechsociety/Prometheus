...
Provides efficient 8-bit quantized inference with RAG context integration.
"""
...
class PrometheusModel:
    ...
    Supports RAG context integration and efficient 8-bit inference.
    """
    ...
    def __init__(self, adapter_path: str, device: str = "auto"):
        ...
        if has_cuda:
            try:
                ...
                logger.info("✅ 8-bit quantization enabled (GPU + bitsandbytes available)")
            except ImportError:
    ...
    def _format_instruction(
        self, raw_prompt: str, target_model: str, rag_context: str | None
    ) -> str:
