...
async def lifespan(app: FastAPI):
    ...
    try:
        ...
        except Exception as e:  # pragma: no cover - best-effort on startup
...
class AugmentRequest(BaseModel):
    ...
    use_rag: bool = Field(default=True, description="Include RAG context from knowledge base")
...
async def root():
    ...
    return {
        ...
        "status": "operational",
        "version": "1.0.0",
        "endpoints": {"augment": "/augment", "health": "/health", "docs": "/docs"},
    }
...
async def augment_prompt(request: AugmentRequest):
    ...
    try:
        ...
        traceback.print_exc()
        raise HTTPException(status_code=500, detail=f"Prompt enhancement failed: {str(e)}") from e
...
async def health_check():
    ...
    try:
        ...
        health_status["rag"] = {"available": False, "ready": False, "error": str(e)}
