...
class VectorStore:
    ...
    def search(self, query: str, top_k: int = 5, target_model: Optional[str] = None):
        """Search for similar documents."""
        return search(query, top_k, target_model)
    
    def add_documents(self, doc_texts: List[str], metadatas: List[dict], ids: Optional[List[str]] = None):
